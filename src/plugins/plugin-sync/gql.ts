...
export enum Permission {
  ...
  Owner = 'Owner',
  /** Allows access to the syncProductData mutation */
...
export type ProductSyncLog = Node & {
  __typename?: 'ProductSyncLog';
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  updatedAt: Scalars['DateTime']['output'];
...
export type ProductSyncLogFilterParameter = {
  createdAt?: InputMaybe<DateOperators>;
  id?: InputMaybe<IdOperators>;
  name?: InputMaybe<StringOperators>;
  updatedAt?: InputMaybe<DateOperators>;
...
export type ProductSyncLogList = PaginatedList & {
  __typename?: 'ProductSyncLogList';
  items: Array<ProductSyncLog>;
  totalItems: Scalars['Int']['output'];
};

export type ProductSyncLogListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<ProductSyncLogFilterParameter>;
  /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>;
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>;
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<ProductSyncLogSortParameter>;
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>;
};

export type ProductSyncLogSortParameter = {
  createdAt?: InputMaybe<SortOrder>;
  id?: InputMaybe<SortOrder>;
  name?: InputMaybe<SortOrder>;
  updatedAt?: InputMaybe<SortOrder>;
...
export type Query = {
  ...
  productSyncLog?: Maybe<ProductSyncLog>;
  productSyncLogs: ProductSyncLogList;
...
export type QueryProductSyncLogArgs = {
  id: Scalars['ID']['input'];
};


export type QueryProductSyncLogsArgs = {
  options?: InputMaybe<ProductSyncLogListOptions>;
};
